...
* **Parameters:**
  ...
  * **sample_colors** (*list* *[*[*ManimColor*](manim.utils.color.core.ManimColor.md#manim.utils.color.core.ManimColor) *]*  *|* *None*) – A custom list of Manim colors to sample from. Defaults to the full Manim
    color palette.
