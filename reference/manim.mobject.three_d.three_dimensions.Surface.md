...
* **Parameters:**
  ...
  * **checkerboard_colors** (*Iterable* *[*[*ParsableManimColor*](manim.utils.color.core.md#manim.utils.color.core.ParsableManimColor) *]*  *|* *Literal* *[**False* *]*) – ng individual faces alternating colors. Overrides `fill_color`.
...
* **Parameters:**
  * **colors** ([*ParsableManimColor*](manim.utils.color.core.md#manim.utils.color.core.ParsableManimColor)) – List of colors for alternating pattern.
...
* **Parameters:**
  * **axes** ([*ThreeDAxes*](manim.mobject.graphing.coordinate_systems.ThreeDAxes.md#manim.mobject.graphing.coordinate_systems.ThreeDAxes)) – The axes for the parametric surface, which will be used to map
    axis-values to colors.
  * **colorscale** (*Iterable* *[*[*ParsableManimColor*](manim.utils.color.core.md#manim.utils.color.core.ParsableManimColor) *]*  *|* *Iterable* *[**tuple* *[*[*ParsableManimColor*](manim.utils.color.core.md#manim.utils.color.core.ParsableManimColor) *,* *float* *]* *]*  *|* *None*) – A list of colors, ordered from lower axis-values to higher axis-values.
