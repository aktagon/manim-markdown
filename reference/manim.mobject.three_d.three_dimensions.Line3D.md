...
* **Parameters:**
  * **start** ([*Point3DLike*](manim.typing.md#manim.typing.Point3DLike)) – The start point of the line.
  * **end** ([*Point3DLike*](manim.typing.md#manim.typing.Point3DLike)) – The end point of the line.
  ...
  * **resolution** (*int* *|* *tuple* *[**int* *,* *int* *]*) – The resolution of the line.
...
* **Parameters:**
  ...
  * **point** ([*Point3DLike*](manim.typing.md#manim.typing.Point3DLike)) – The point to pass through.
...
* **Parameters:**
  ...
  * **direction** ([*Vector3DLike*](manim.typing.md#manim.typing.Vector3DLike) *|* *None*) – If an edge of a [`Mobjects`](manim.mobject.mobject.Mobject.md#manim.mobject.mobject.Mobject) should be returned, the direction of the edge.
* **Returns:**
...
* **Parameters:**
  * **start** ([*Point3DLike*](manim.typing.md#manim.typing.Point3DLike)) – Starting point or `Mobject`.
  * **end** ([*Point3DLike*](manim.typing.md#manim.typing.Point3DLike)) – Ending point or `Mobject`.
  * **kwargs** (*Any*)
* **Return type:**
  None
